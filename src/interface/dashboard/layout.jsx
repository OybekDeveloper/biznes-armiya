    ...
    <>
      ...
      <main className="flex flex-col gap-[20px] md:px-[20px] pb-[20px]">
        ...
        <section className="flex gap-[30px] max-lg:flex-col ">
          <div className="lg:flex-1 bg-card shadow-btn_shadow rounded-[24px] p-[18px] flex flex-col">
            ...
            <div className="grid xl:grid-cols-4 lg:grid-cols-2 max-sm:grid-cols-1 sm:grid-cols-2 flex-1 gap-2">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((item, idx) => (
                <div
                  className="w-full h-full bg-background rounded-[24px] p-[16px] flex flex-col justify-start items-center gap-1"
                  key={idx}
                >
                  <img
          ...
          <div className="w-full lg:w-1/3 bg-card shadow-btn_shadow rounded-[24px] p-[18px] flex flex-col">
            <div className="w-full flex justify-between items-center mb-[20px]">
