...
const Saidbar = () => {
  ...
  const saidbarData = [
    ...
    },
    {
      ...
      icon: <FaTasks />,
      link: "/homework",
      active: role?.tasks_views ? true : false,
    },
    {
      id: 3,
      title: "VAB history",
      icon: <MdWorkHistory />,
      link: "/history",
      active: role?.vab_views ||role?.h_balls_views ? true : false,
    },
    {
      id: 4,
      title: "Auktsion",
      icon: <RiAuctionFill />,
      link: "/auktsion",
      active: role?.auktsion_views ? true : false,
    },
    {
      id: 5,
      title: "Requirements",
      ...
      link: "/requirements",
      active: role?.talab_views ? true : false,
    },
    {
      id: 6,
      title: "Checklist",
      ...
      link: "/checklist",
      active: role?.check_list_done ? true : false,
    },
    {
      id: 7,
      title: "News",
      icon: <FaNewspaper />,
      link: "/news",
      active: role?.yang_views ? true : false,
    },
    {
      id: 7,
      title: "Settings",
